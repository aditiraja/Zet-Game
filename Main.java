...
/**
 *  A main class for the network Zet game.  Main routine
 *  shows a dialog where the user can choose to be a server or
 *  a client.  If the user chooses to be a server, then a ZetHub
 ...
 *  In either case, a ZetWindow is created where the game will 
 *  be played.
 */
public class Main {

    private static final int DEFAULT_PORT = 10121;
    
    public static void main(String[] args) {
        
        // First, construct a panel that will be placed into a JOptionPane confirm dialog.
        
        JLabel message = new JLabel("Welcome to Networked Zet Game!", JLabel.CENTER);
        ...
        while (true) {  // Repeats until a game is started or the user cancels.
            ...
            int action = JOptionPane.showConfirmDialog(null, inputPanel, "Net Zet", 
    ...
    public static void launchGame(String hostName, int serverPortNumber) throws IOException
    {
        ZetNetGame w = new ZetNetGame(hostName, serverPortNumber);
