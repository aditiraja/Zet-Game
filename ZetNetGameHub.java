...
/**
 * A "Hub" for the network Zet game. There is only one Hub
 ...
 * same state.
 */
public class ZetNetGameHub extends Hub {
    
    private ZetNetGameState state;  // Records the state of the game.
    /**
     ...
     */
    public ZetNetGameHub(int port) throws IOException {
        super(port);
        state = new ZetNetGameState();
        setAutoreset(true);
    }
